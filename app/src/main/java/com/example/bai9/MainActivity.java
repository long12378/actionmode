...
public class MainActivity extends AppCompatActivity{
    ...
    private void AnhXa(){
        ...
        arraySinger.add(new Singer("my face is murder","dethklok"));
        arraySinger.add(new Singer("master of the pupets","metalica"));
        arraySinger.add(new Singer("G.O.A.T","Polyphia"));
        arraySinger.add(new Singer("through the fire and flames","Dragonforce"));
